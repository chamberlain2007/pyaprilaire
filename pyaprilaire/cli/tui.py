...
class AprilaireTui(App):
    ...
    def action_functions(self) -> None:
        ...
        self.run_worker(self._function_flow())
    ...
    def action_packet(self) -> None:
        ...
        self.run_worker(self._packet_flow())
        ...
        if fields:
            result = await self.push_screen_wait(
                FormScreen(
                    ...
                    description="A field left blank is sent as NULL, leaving it"
                    " unchanged.",
                )
            )
    ...
    def action_raw(self) -> None:
        ...
        self.run_worker(self._raw_flow())
